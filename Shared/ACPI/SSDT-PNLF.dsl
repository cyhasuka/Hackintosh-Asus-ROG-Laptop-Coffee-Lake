        ...
        Method (_INI, 0, NotSerialized)  // _INI: Initialize
        {
                                ...
                                }, MEQ, Local0, MTR, Zero, Zero))))
            {
                ...
                If ((!(0x08 & Local4) && (Local2 != Local1)))
                {
                    ...
                    If ((Local2 > Local1))
                    {
                        ^LEVX = Local3 /* \_SB_.PCI0.GFX0.PNLF.LEVX */

                        ^LEVL = Local0 /* \_SB_.PCI0.GFX0.PNLF.LEVL */
                    }
                                ...
                                }, MEQ, Local0, MTR, Zero, Zero))))
            {
                ...
                If ((!(0x08 & Local4) && (Local2 != Local1)))
                {
                    ...
                    If ((Local2 > Local1))
                    {
                        ^LEVX = Local2 /* \_SB_.PCI0.GFX0.PNLF.LEVX */

                        ^LEVD = Local0 /* \_SB_.PCI0.GFX0.PNLF.LEVD */
                    }
            ...
            Else
            {
                ...
                If ((!(0x08 & Local4) && (Local2 != Local1)))
                {
                    Local0 = ((((^LEVX & 0xFFFF) * Local2) / Local1) | 
                        (Local2 << 0x10))
                    ^LEVX = Local0 /* \_SB_.PCI0.GFX0.PNLF.LEVX */
                }
            }
